...
const Login = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-6 sm:px-8 lg:px-0">
      ...
      <button
        onClick={() => {}}
        className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 border border-border rounded-md bg-card hover:bg-muted text-sm font-medium text-foreground transition-colors mb-1"
      >
        <GoogleIcon />
